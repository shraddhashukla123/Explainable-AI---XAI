...
def run_bivariate_regression(
    ...
    # raw_df_final = raw_df_final[
    #     (~raw_df_final["encoded_variable"].str.endswith("_0")) &
    #     (~raw_df_final["encoded_variable"].str.contains("Missing", case=False))
    # ]
    ...
    mm_df_final = mm_df_final[
        (~mm_df_final["encoded_variable"].str.endswith("_0")) &
        (~mm_df_final["encoded_variable"].str.contains("Missing", case=False))
    ]
